## Code of Conduct for Contributing to Django System Monitor

we’re thrilled that you want to contribute to `dj-system-monitor`! to ensure a positive and protective environment for everyone involved, please adhere to the following guidelines.

## Contribution Workflow

1. **Fork and Clone**: Start by forking the `dj-system-monitor` repository on Github and cloning it to your local machine:
    ```bash
    git clone https://github.com/lazarus-org/dj-system-monitor.git
...
Thank you for contributing to `dj-system-monitor`! We look forward to your contributions.
